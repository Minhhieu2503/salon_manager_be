...
//    Optional<Employee> findEmployeeByAccount_UserName(String account_userName);
    ...
    @Query("SELECT new com.example.salonmanager.dto.EmployeeDTO(e.id, e.userName, e.fullName, e.age, e.address, e.phone, e.avatar, " +
    ...
    @Query("SELECT new com.example.salonmanager.response.EmployeeBookedStaffResponse(" +
    ...
    @Query("SELECT new com.example.salonmanager.response.EmployeeAppointmentByHourResponse(" +
