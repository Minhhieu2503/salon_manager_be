...
import com.example.salonmanager.service.uploadimage.ImageUploadService;
...
public class ComboServiceImpl implements ComboService {
    ...
    public void createCombo(ComboDTO comboDTO) {
        try {
            ...
            Set<com.example.salonmanager.entity.Service> services = comboDTO.getServices().stream()
            ...
            Integer totalHaircutTime = services.stream().mapToInt(com.example.salonmanager.entity.Service::getHaircutTime).sum();
    ...
    public void updateCombo(ComboDTO comboDTO) throws IOException {
        try {
            ...
            Integer totalHaircutTime = services.stream()
                    .mapToInt(com.example.salonmanager.entity.Service::getHaircutTime)
                    .sum();
